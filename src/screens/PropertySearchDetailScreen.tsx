...
const PropertySearchDetailScreen = ({ route, navigation }: Props) => {
  ...
  const navigateToMap = () => {
    navigation.navigate('PropertySearchMapScreen', {
...
export default PropertySearchDetailScreen;
